...
import { Ban, XCircle, RefreshCcw, Wrench, Phone, ClipboardList } from 'lucide-react'
  ...
  return (
    <div className="app-shell items-center justify-center px-8 text-center">
      <div className="animate-fade-up flex flex-col items-center gap-4">
        ...
        <h1 className="text-xl font-bold">محلك موقوف حالياً 🚫</h1>
    ...
    <div className="app-shell items-center justify-center px-8 text-center">
      <div className="animate-fade-up flex flex-col items-center gap-4">
        ...
        <p className="max-w-72 text-[11px] leading-relaxed text-faint">
          يمكنك تعديل البيانات وإعادة التقديم — الطلب الجديد منفصل تماماً عن الطلب المرفوض.
        </p>
